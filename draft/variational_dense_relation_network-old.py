...
class EmbeddingSENet(nn.Module):
    ...
    def forward(self, x):
        ...
        return x,[feature1,feature2,feature3,feature4],std_mean
...
class VariationalDenseRelationNetwork(nn.Module):
    ...
    def forward(self, support_x, query_x):
        ...
        if self.num_support > 1: # k shot setting
            _,pre_support_x_features,_ = self.embedding(support_x) #[25,16,xx,xx]
            support_x_features = []
            ...
            _,support_x_features,_ = self.embedding(support_x_ext)
        ...
        _,query_x_features,_ = self.embedding(query_x_ext)
